...
//          print("new: print poses[0]", strongSelf.normalizedPoint(
//               fromVisionPoint: poses[0].landmarks[0].position, width: width, height: height))
...
////show CameraViewController page as the first page
