...
//    //let first page be CameraViewController
//    var body: some View {
//        // Version 1
...
extension ViewController {
  ...
  func detectSegmentationMask(image: UIImage?) {
    ...
    func normalizedPoint(
      ...
      let unNormalizedPointX = normalizedPoint.x
     // normalizedPoint = previewLayer.layerPointConverted(fromCaptureDevicePoint: normalizedPoint)
  //      if(unNormalizedPointX > 1 && unNormalizedPointX < 1.5){
  //          print("Pre-layer", unNormalizedPointX, "Post-layer", normalizedPoint.x)
  //      }
...
//                print(i)
//
//                print("new: print landmarks",
//                      i, "-->", pose.landmarks[i].position
//                      // this is a function
//                      , self.normalizedPoint(
//                                     fromVisionPoint: pose.landmarks[i].position, width: width, height: height)
//                )
//                print("likelihood", pose.landmarks[i].inFrameLikelihood)
//            }
//
...
//          print("nose x,y:", poses[0].landmarks[0].position)
          print("height:", height, "width", width)
          print("Pose count:", random_counter)
          print("left hip landmark position:", poses[0].landmark(ofType: PoseLandmarkType.leftHip).position)
          print("right hip landmark position:", poses[0].landmark(ofType: PoseLandmarkType.rightHip).position)
         // print("new: print landmarks",
          //                      i, "-->", pose.landmarks[i].position
          //                      // this is a function
          //                      , self.normalizedPoint(
          ...
          //                print("likelihood", pose.landmarks[i].inFrameLikelihood)
          //            }
//         print("orginal: print poses[0]", poses[0].landmarks[0].position)
...
private enum Constants {
  static let images = [
    "grace_hopper.jpg", "squat.jpeg","image_has_text.jpg", "chinese_sparse.png", "chinese.png",
