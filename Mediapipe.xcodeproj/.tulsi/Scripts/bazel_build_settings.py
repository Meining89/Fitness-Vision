...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_dora/3997ee8133d8cbeba184296832f09082/execroot/mediapipe',
    '/private/var/tmp/_bazel_dora/3997ee8133d8cbeba184296832f09082',
    'ios_x86_64',
    {
        'watchos_armv7k': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/dora/Library/Application Support/Tulsi/0.20221005.88/Bazel',
